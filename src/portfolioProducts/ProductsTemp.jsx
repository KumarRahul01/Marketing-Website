        ...
        <div className="flex md:flex-row flex-col items-start justify-center gap-10">
          ...
          <div className="md:w-1/3 flex flex-col gap-10 p-5 md:p-0">
            <div className="shadow-xl border-2 p-8">
              <h1 className="text-3xl font-semibold text-[#7A6960]">Project Information</h1>
              ...
              <ul className="mt-3">
                ...
                <li>
                  <span className="font-semibold ">Project Url:</span> <span className="text-orange-600">www.example.com</span>
                </li>
              </ul>
            </div>
            <div>
              <h1 className="text-3xl font-semibold text-[#7A6960]">Lorem ipsum dolor sit amet.</h1>
              <p className="mt-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto dicta mollitia, labore deserunt repellat temporibus animi pariatur accusamus enim unde rerum id qui beatae neque, perferendis maxime facilis nulla quos saepe iste non optio quam in! Dolorem hic nulla porro?</p>
            </div>
          </div>
        </div>
      </section>
